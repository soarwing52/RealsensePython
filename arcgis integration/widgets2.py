    ...
    *textprops*: dict, default is None
    ...
    def update_text(self):
        if self.length_unit is not None:
            ...
            detail_string = 'ang:' +str(self.ruler_angle)+ 'deg'+'\nL:'+str(self.ruler_length[0])+'cm \n'+'point1:'+str(self.ruler_length[1]) +'\npoint2:'+str(self.ruler_length[2])
            #detail_string = 'angle:{:0.3} deg; L: {:0.3} ; dx: {:0.3} ; dy: {:0.3} ; '.format(str(self.ruler_angle),str(self.ruler_length[0]),str(self.ruler_length[1]),str(self.ruler_length[2]))
    ...
    def calculate_3D(self, xa,xb,ya,yb,depth_frame,color_intrin):
        ...
        cm = dist * 100
        decimal2 = "%.2f" % cm
        point1 = [ '%.3f' % elem for elem in point1 ]
        point2 = [ '%.3f' % elem for elem in point2 ]
        return decimal2,point1,point2
